            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="main_title text-center">
                        <h2>Modify Service Offering</h2>
                        <p>Change details or replace the illustration for the service card.</p>
                    </div>
                    
                    <div class="admin-card animate-up" style="padding: 40px;">
                        <h3 class="mb-4" style="font-family: 'Space Grotesk', sans-serif; color: var(--text-primary); font-weight: 700; border-bottom: 2px solid #edf2f7; padding-bottom: 15px;">Edit Service Details</h3>
                        
                        <form action="${pageContext.request.contextPath}/admin/updateService?id=${service.id}" method="POST" enctype="multipart/form-data" class="row contact_form">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="title" placeholder="e.g. Backend Development" value="${not empty serviceDto.title ? serviceDto.title : service.title}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="4" placeholder="Describe the service details (min 10 characters)..." required>${not empty serviceDto.description ? serviceDto.description : service.description}</textarea>
                                </div>
                            </div>

                            <div class="col-md-12 mb-3">
                                <c:if test="${not empty service.image}">
                                    <div class="current-image-preview" style="padding: 15px; background: rgba(0, 119, 181, 0.03); border: 1px solid rgba(0, 119, 181, 0.1); border-radius: var(--radius-md); display: inline-block;">
                                        <span class="d-block text-muted mb-2" style="font-size: 0.8rem; font-weight: 600; text-transform: uppercase;">Current Image</span>
                                        <img src="${pageContext.request.contextPath}/img/services/${service.image}" alt="${service.title}" style="max-height: 70px; max-width: 70px; object-fit: contain; border-radius: 4px;">
                                    </div>
                                </c:if>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="image" style="font-weight: 600; color: var(--text-primary); font-family: 'Space Grotesk', sans-serif;">Replace Icon / Illustration <span class="text-muted">(Optional)</span></label>
                                    <div class="custom-file-upload" style="border: 2px dashed #cbd5e0; padding: 25px; border-radius: var(--radius-lg); text-align: center; background: #f8fafc; cursor: pointer; position: relative; transition: var(--transition);">
                                        ...
                                        <span id="file-label" style="font-weight: 500; color: var(--text-muted);">Choose new image file to replace...</span>
                                    ...
                                    <small class="text-muted mt-2 d-block">Recommended dimensions: 120x120px png file. Max file size: 2MB. Leave empty to keep the current image.</small>
                                </div>
                            </div>
            ...
            if (fileInput && fileLabel) {
                fileInput.addEventListener("change", function(e) {
                    if (fileInput.files.length > 0) {
                        ...
                        fileLabel.textContent = "Choose new image file to replace...";
